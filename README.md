...
|-------|-------|--------------|
| 1 | `ThrottlerGuard` | `APP_GUARD` ใน `app.module.ts` (Global) |
| 2 | `JwtAuthGuard` | `APP_GUARD` ใน `app.module.ts` (Global) |
...
├── app.module.ts                  # Root module + global providers + RequestId middleware
